  ...
  <div class="container">
    ...
    <form action="<spring:url value="/user/doneforgotpass"/>" method="post" class="login-form login-form2" >
        ...
        <div class="input-group">
          ...
          <input name="key" type="password" class="form-control" placeholder="key" autofocus required="required">
        </div>
        <div class="input-group">
          <span class="input-group-addon"><i class="icon_contacts_alt"></i></span>
          <input name="pass" type="password" class="form-control" placeholder="password" autofocus required="required">
        </div>
        <div class="input-group">
          <span class="input-group-addon"><i class="icon_contacts_alt"></i></span>
          <input name="cpass" type="password" class="form-control" placeholder="confirm password" autofocus required="required">
        </div>
