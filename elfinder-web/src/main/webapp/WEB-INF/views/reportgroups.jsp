				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-laptop"></i> Cluster Report
						</h3>
					...
					<div class="col-lg-9 col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-flag-o red"></i><strong>My Cluster</strong>
								</h2>
								...
								<table class="table bootstrap-datatable countries"
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<form target="_blank"
													action='<spring:url value="/reports/reportgroup" ></spring:url>'
													method="post">
													<input type="hidden" name="fgid"
														value="<%=fg.getFgid()%>" />
													<button class="btn btn-info notika-btn-teal" target="" type="submit">More
														Info</button>
												</form>
											</td>
										</tr>
