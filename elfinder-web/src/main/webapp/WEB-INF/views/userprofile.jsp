                  ...
                  <form enctype="multipart/form-data" class="form-validate form-horizontal" id="register_form" action="<spring:url value="/user/profile"/>" method="post">
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class=" form-control" id="fullname" name="fname" type="text" value="<%= Util.nullCheck(u.getFname()) %>"  />
							</div>
						</div>
						...
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class=" form-control" id="fullname" name="lname" type="text" value="<%= Util.nullCheck(u.getLname()) %>"  />
							</div>
						</div>
					</div>
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								...
								minlength="10"
								maxlength="10"
								value="<%= Util.nullCheck(u.getNationalCode()) %>" />
							</div>
						</div>
