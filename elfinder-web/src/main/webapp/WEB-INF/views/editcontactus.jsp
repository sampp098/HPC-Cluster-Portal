  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> Edit Contact us</h3>
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>Edit Contact us</li>
            </ol>
          </div>
        </div>
        ...
        <!-- myform-->
				...
				<div class="col-lg-6">
					<section class="panel">
						<header class="panel-heading"> Contact US Form </header>
						<div class="panel-body">
							<form role="form"
								action="<spring:url value="/admin/editcontactus"/>"
								method="post">
								<!-- CKEditor -->
								<div class="form-group">
									<label for="text">Type Here</label>
									<textarea class="form-control ckeditor" name="text"
										placeholder="Enter the Text"  ><%=text %></textarea>
								</div>
