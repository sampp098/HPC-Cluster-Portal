				...
				<div class="row">
					<div class="col-lg-12">
						...
						<h3 class="page-header">
							<i class="fa fa-laptop"></i>Report of User '<%= member.getUserName() %>'
						</h3>
					...
					<div class="col-lg-9 col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-flag-o red"></i><strong>My Report</strong>
								</h2>
							...
							<div class="panel-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td ><% if(j.getState().equals("R")){out.write("Running");}else if(j.getState().equals("Q")){out.write("Queued");}else if(j.getState().equals("C")){out.write("Finished");} %></td>
                                        <td><%= String.format ("%.3f", (double)obj[1])%></td>
...
<!-- ****************************************************************************	 -->
	...
	<script type="text/javascript">
		...
		for(Object[] obj : (List<Object[]>) request.getAttribute("jobsPie") ) {
				//obj[0]= appname
				//obj[1]= Memory Average
				//obj[2]= Core num average
				//obj[3]= CPU time Sum
				//obj[4]= Cost Sum
				data1+="['"+obj[0]+"', "+obj[3]+"],";
				data2+="['"+obj[0]+"', "+obj[1]+"],";
