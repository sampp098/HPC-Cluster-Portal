		...
		<div class="col-lg-6">
            <section class="panel">
              ...
              <div class="panel-body">
                <form role="form" action="<spring:url value="/messaging/doupdatenews"/>" method="post" >
                  
                  <% News n=(News)request.getAttribute("news"); %>
                  <input type="hidden" name="nid" value="<%= n.getNid()%>">
				  <div class="form-group">
                    <label for="exampleInputEmail1">title</label>
                    <input name="title" type="text" class="form-control"  placeholder="Enter the title" minlength="3" maxlength="45" required="required" value="<%= n.getTopic()%>">
                  </div>
                  
					<!-- CKEditor -->
                  <div class="form-group">
                     <label for="text">Text</label>
                     <textarea class="form-control ckeditor" name="text" placeholder="Enter the news"><%= n.getText()%></textarea>
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input name="expire" id="dp1" type="text"  size="16" class="form-control" required="required" readonly="readonly" min="5"
                           value='<%=new SimpleDateFormat("MM-dd-yyyy").format(n.getExpdate())%>'>
                        </div>
                  </div>
