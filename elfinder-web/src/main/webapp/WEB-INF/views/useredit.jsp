  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
          <%  User u=((User) request.getAttribute("selecteduser")); %>
         
            <h3 class="page-header"><i class="fa fa-files-o"></i> Profile for <%= u.getUserName() %></h3>
                  ...
                  <form class="form-validate form-horizontal" id="register_form" action="<spring:url value="/user/edit"/>" method="post">
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class=" form-control" id="fullname" name="fname" type="text" value="<%= Util.nullCheck( u.getFname()) %>" readonly />
							</div>
						</div>
						...
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class=" form-control" id="fullname" name="lname" type="text" value="<%= Util.nullCheck(u.getLname()) %>" readonly />
							</div>
						</div>
					</div>
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class="form-control " id="cemail" type="email" name="email" required value="<%= Util.nullCheck(u.getEmail()) %>" readonly/>
							</div>
						</div>
						...
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class="form-control " id="username" name="username" type="text" readonly value="<%= Util.nullCheck(u.getUserName()) %>" readonly/>
							</div>
						</div>
					</div>
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input id="ncode" class=" form-control" id="fullname" name="nationalcode" type="text" value="<%= Util.nullCheck(u.getNationalCode()) %>" 
								required
								pattern="[0-9]*"
								minlength="10"
								maxlength="10"
							...
							<div class="col-lg-6">
								<select class="form-control m-bot15" name="grade">
									<% for(Grade g: (List<Grade>) request.getAttribute("grade")){%>
    									<option value="<%=g.getGradeid() %>" <% if(g.getGradeid()==u.getGradeid()){%> selected="selected" <%} %>>
							...
							<div class="col-lg-6">
								<select class="form-control m-bot15" name="university">
									<% for(University g: (List<University>) request.getAttribute("univesity")){%>
    									<option value="<%=g.getUnid() %>" <% if(g.getUnid()==u.getUnid()){%> selected="selected" <%} %>>
							...
							<div class="col-lg-6">
								<select class="form-control m-bot15" name="faculty">
									<% for(Faculty g: (List<Faculty>) request.getAttribute("faculty")){%>
    									<option value="<%=g.getFacultyid() %>" <% if(g.getFacultyid()==u.getFacultyid()){%> selected="selected" <%} %>>
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class=" form-control" id="fullname" name="field" type="text" value="<%= Util.nullCheck(u.getField()) %>"
								required
								minlength="4"
								maxlength="45"
								/>
						...
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<select class="form-control m-bot15" name="state">
										<option value="1" <%if(u.getState()==1){ out.write("selected=\"selected\""); }%> >profesor</option>
										<option value="2" <%if(u.getState()==2){ out.write("selected=\"selected\""); }%>>student</option>
										<option value="3" <%if(u.getState()==3){ out.write("selected=\"selected\""); }%>>none</option>
								</select>
							</div>
						</div>
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class=" form-control" id="fullname" name="sn_pn" type="text" value="<%= Util.nullCheck(u.getSN_PN()) %>"
								required
								pattern="[0-9]*"
								minlength="6"
								maxlength="12"
						...
						<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<input class=" form-control" id="fullname" name="phone" type="text" value="<%= Util.nullCheck(u.getPhone())%>"
								required
								pattern="[0-9]*"
								minlength="5"
								maxlength="14"
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-12">
							...
							<input class=" form-control" id="address" name="address" type="text" value="<%= Util.nullCheck(u.getAddress()) %>"
							required
							minlength="10"
							maxlength="200"
							/>
					...
					<div class="form-group row col col-lg-12">
						...
						<div class="col col-lg-6">
							...
							<br>
    						<img align="middle" id="im1" src='<spring:url value="/user/imageController/"></spring:url><%=""+u.getUid()%>/myicon.jpg' alt="your image" style=" margin-left: auto; margin-right: auto; max-width:300px; max-height: 200px;" />
						</div>
						...
						<div class="col col-lg-6">
							...
							<br>
							<img align="middle" id="im2" src='<spring:url value="/user/imageController/"></spring:url><%=""+u.getUid()%>/myncard.jpg' alt="your image" style=" margin-left: auto; margin-right: auto; max-width:300px; max-height: 200px;" />
						</div>
					...
					<div class="form-group row col col-lg-12">
						...
						<div class="col col-lg-6">
							...
							<br>
							<img align="middle" id="im3" src='<spring:url value="/user/imageController/"></spring:url><%=""+u.getUid()%>/myst_pr_card.jpg' alt="your image" style=" margin-left: auto; margin-right: auto; max-width:300px; max-height: 200px;" />
						</div>
						...
						<div class="col col-lg-6">
							...
							<br>
							<img align="middle" id="im4" src='<spring:url value="/user/imageController/"></spring:url><%=""+u.getUid()%>/myracommandation.jpg' alt="your image" style=" margin-left: auto; margin-right: auto; max-width:300px; max-height: 200px;" />
						</div>
					</div>
					...
					<div class="row form-group col-lg-12">
						<div class="col-lg-6">
							...
							<div class="col-lg-4 input-append date" id="dpYears" data-date="<%=u.getExptime().toString().split(" ")[0] %>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
								<input name="expire" class="form-control" size="16" type="text" value="<%=u.getExptime().toString().split(" ")[0] %>" readonly>
						...
						<div class="col-lg-6 radios">
							<label class="label_radio col-lg-3" for="radio-02">
                                <input name="active" id="radio-01" value="1" type="radio" <% if(u.getIsactive()==1){ %> checked <%}%> />active
                            </label>
                            <label class="label_radio col-lg-3" for="radio-02">
                                <input name="active" id="radio-02" value="0" type="radio" <% if(u.getIsactive()==0){ %> checked <%}%>  /> inactive
                            </label>
