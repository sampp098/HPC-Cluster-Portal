...
<%@page import="bab.mvc.data.entities.complex.GroupJobsComplex"%>
	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-laptop"></i> My Group Report
						</h3>
						...
						<ol class="breadcrumb">
							...
							<li><i class="icon_document_alt"></i>Group</li>
              				<li><i class="fa fa-files-o"></i>My Group Report</li>
						</ol>
					</div>
				</div>
				<!--/.row-->
				...
				GroupJobsComplex groupJobsComplex=(GroupJobsComplex) request.getAttribute("groupjobs");  
									...
									<h4>
										<div>
											<label for="cemail" class="col-lg-3">group name: </label><label>
												<%=groupJobsComplex.getFgname()%></label>
										</div>
										<div>
											<label for="cemail" class="col-lg-3">group owner:</label><label>
												<%=groupJobsComplex.getOwner().getFname() + " " + groupJobsComplex.getOwner().getLname()%></label>
										</div>
										<div>
											<label for="cemail" class="col-lg-3">remaining
												charge: </label><label><%=groupJobsComplex.getCharge()%> Coins</label>
										</div>
									</h4>
								</div>
							</div>
								...
								<div class="panel-body">
									<table class="table bootstrap-datatable countries" id="jobstable">
										...
										<tbody>
											...
											<!-- users list -->
											<%
												Set<JobsComplex> js = groupJobsComplex.getJobs();
											...
											<tr <%if (j.getState().equals("C")) {%> bgcolor="ccffcc"
												...
												<form action="<spring:url value="/job/editselected"/>"
													...
													<td><input type="hidden" name="jobid"
														...
														name="jid" value="<%=j.getJid()%>"><%=j.getJobid()%>
													</td>
													<td><input type="hidden" name="username"
														value="<%=j.getUser().getUserName()%>"><%=j.getUser().getUserName()%></td>
													<td><input type="hidden" name="appname"
														value="<%=j.getAppname()%>"><%=j.getAppname()%></td>
