...
public class UserComplex {
	...
	@JoinColumn(name="uid")
	private  Set<GroupUsersComplex> groups;
	
	public UserComplex() {
		super();
	}

	public UserComplex(String fname, String lname, String userName, String pass,
	...
	public UserComplex(String fname, String lname, String userName, String pass,String email, Date createtime, int isactive) {
		super();
		this.fname = fname;
		this.lname = lname;
		this.userName = userName;
	...
	public String toString() {
		return "User [uid=" + uid + ", fname=" + fname + ", lname=" + lname + ", userName=" + userName + ", pass="
				+ pass + ", nationalCode=" + nationalCode + ", email=" + email + ", address=" + address + ", phone="
				+ phone + ", state=" + state + ", SN_PN=" + SN_PN + ", unid=" + unid + ", facultyid=" + facultyid
				+ ", field=" + field + ", gradeid=" + gradeid + ", nationalCard=" + nationalCard + ", recommendation="
				+ recommendation + ", createtime=" + createtime + ", exptime=" + exptime + ", isactive=" + isactive
				+ ", st_pr_card=" + st_pr_card + ", groups=" + groups + "]";
	}
	...
	public Set<GroupUsersComplex> getGroups() {
		return groups;
	}

	public void setGroups(Set<GroupUsersComplex> groups) {
		this.groups = groups;
	}
