package bab.mvc.filmanager.config;
...
public class ElFinderConfig {
    ...
    public ElfinderStorageFactory getElfinderStorageFactory() {
        ...
        elfinderStorageFactory.setElfinderStorage(getElfinderStorage("ubuntu"));
        return elfinderStorageFactory;
    }

    @Bean(name = "elfinderStorage")
    public ElfinderStorage getElfinderStorage(String username) {
        ...
        for (Node elfinderConfigurationVolume : elfinderConfigurationVolumes) {
            ...
            // creates new volume
            Volume volume = VolumeSources.of(source).newInstance(alias, path, username);
