				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-laptop"></i> New Application
						</h3>
						...
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="<spring:url value="/user/hpchome"/>">Home</a></li>
              				...
              				<li><i class="fa fa-files-o"></i>New Application>
						</ol>
					</div>
				</div>
				<!--/.row-->
					...
					<div class="col-lg-9 col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-flag-o red"></i><strong>New Application</strong>
								</h2>
							</div>
							<div class="panel-body">
							
							<form class="form-validate form-horizontal" id="register_form" action="<spring:url value="/apps/donewapp"/>" method="post">
								<div>
										<h3>Notice: file1,file2,file3... are input files of defined type files</h3>
										<hr>
										<label >Application name(Exact as folder name): <input type="text" name="appname" /></label>
								</div>
								<table class="table bootstrap-datatable countries" id="texport">
									...
									<tbody>
										<tr>
											<td class="td_t"><input type="text" name="export"  class="col-lg-9"/></td>
										</tr>
									</tbody>
								</table>
								...
								<table class="table bootstrap-datatable countries" id="tscript">
									...
									<tbody>
										<tr>
											<td><input type="text" name="script" class="col-lg-9"/></td>
										</tr>
									</tbody>
								</table>
								...
								<table class="table bootstrap-datatable countries" id="ttype">
									...
									<tbody>
										<tr>
											<td><input type="text" name="type" class="col-lg-9" /></td>
										</tr>
									</tbody>
								</table>
