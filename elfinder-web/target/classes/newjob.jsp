								...
								<%} %>
									...
									<div class="col-lg-12 form-group">
										...
										<div id="advancedtext" class="col-lg-12 form-group">
											<textarea onkeypress="count();" onkeyup="count();" maxlength="5000" id="text" class="round-inpu col-lg-9" rows="4" cols="70" name="editscripts"><%= scripts%></textarea>
											<h6 class="pull-right label label-default" id="count_message">0/5000</h6>
      										<br>
										</div>
