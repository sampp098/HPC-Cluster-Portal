...
<script>
  function deactive_app(name,id) {
	 var SplitText = ""+name+"application?";
	 ...
	 $dialog.dialog('open');
	 $dialog.html('<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>Do you want to '+name+' this application?</p>');
  }
</script>
										...
										<form action='<spring:url value="/apps/editapp"></spring:url>' method="post"> 
											...
											<td>
                      							<div class="btn-group">
                        							...
                        							<%if(a.getActive()==1){ %>
                        								<input  type="button" name="button" value="deactive"   class="btn btn-danger btn-sm" onclick='deactive_app("deactive","activeform<%=i%>");'/>
                        							<%} else{ %>
                        								<input  type="button" name="button" value="active"   class="btn btn-primary btn-sm" onclick='deactive_app("active","activeform<%=i%>");'/>
                        							<%} %>
                      							</div>
                    						</td>
										</form>
										<form id="activeform<%=i%>" action='<spring:url value="/apps/activeapp"></spring:url>' method="post"> 
