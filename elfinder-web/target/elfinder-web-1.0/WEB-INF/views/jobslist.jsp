							...
							<div class="panel-body">
								<div class="row">
									<div class="btn-group btn-group-justified">
											 <a class="btn btn-info active" style="background-color: white; color: #000000;" >Queued</a>
											 <a class="btn btn-warning" style="background-color: #ffff80; color: #000000;">Running</a>
											 <a class="btn btn-success" style="background-color: #ccffcc; color: #000000;">Concluded</a>
									</div>
								...
								<table class="table bootstrap-datatable countries" id="jobstable">
									...
									%>
										...
										<form  action="<spring:url value="/job/editselected"/>" method="post"> 
											...
											<td><%= row%></td>
											<td><input type="hidden"  name="jobid" value="<%= j.getJobid() %>" >
												<input type="hidden"  name="jid" value="<%= j.getJid() %>"><%= j.getJobid() %> </td>
