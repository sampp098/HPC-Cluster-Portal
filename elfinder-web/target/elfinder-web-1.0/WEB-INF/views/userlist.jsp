							...
							<div class="panel-body">
								...
								<div class="row">
									<div class="btn-group btn-group-justified">
											 <a class="btn btn-info active" style="background-color: #ccffcc; color: #000000;" >Normal</a>
											 <a class="btn btn-warning" style="background-color: #ff9999; color: #000000;">Inactive</a>
											 <a class="btn btn-success" style="background-color: #ffff80; color: #000000;">Expired</a>
									</div>
								...
								<table class="table bootstrap-datatable countries" id="userstable">
									...
									%>
										...
										<form action="<spring:url value="/user/editselected"/>" method="post"> 
											...
											<td>
                      							<div class="btn-group">
                        							<%if(!isAdmin){ %><input  type="submit" name="button" value="edit"   class="btn btn-primary" /><%} %>
