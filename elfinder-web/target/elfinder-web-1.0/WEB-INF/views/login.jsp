  ...
  <div class="container">
    ...
    <form action="<spring:url value="/user/login"/>" method="post" class="login-form" >
      ...
      <div class="login-wrap" >
        ...
        <label class="checkbox">
                <!--<input type="checkbox" value="remember-me"> Remember me -->
                <span class="pull-left">  <a target="_blank" href="<spring:url value="/user/freecontact"/>">Contact US</a></span>
                <span class="pull-right"> <a target="_blank" href="<spring:url value="/user/documentation/Help_users.pdf" />">Help?</a></span>
        </label>
