		 ...
		 <li class="sub-menu">
 		 ...
 		 <li class="sub-menu">
             ...
             <ul class="sub">
			   ...
			   <%if(PermissionsService.exist(permissionList, "tariffnew")){ %><li><a target="_blank" class="" href="http://10.14.20.10/ganglia/">Monitoring</a></li><%} %>
		 ...
		 <%}
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a target="_blank" class="" href="<spring:url value="/user/contact" />" >Contact us</a></li>
            </ul>
          </li>
		 <%
		 }%>
